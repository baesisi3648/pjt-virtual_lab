  ...
  return (
    <div className="report-editor h-full flex flex-col">
      ...
      <div className="flex justify-between items-center p-4 border-b border-gray-700">
        <h2 className="text-xl font-bold text-white">최종 보고서</h2>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {isEditMode ? (
          ...
          <textarea
            ...
            className="w-full h-full p-4 border border-gray-700 rounded bg-gray-800 text-gray-100 font-mono text-sm resize-none focus:outline-none focus:border-blue-500"
          ...
          <div className="space-y-6">
            {sections.map((section, index) => (
              <div
                key={index}
                className="section-container border-l-4 border-blue-500 pl-4 py-2 hover:bg-gray-800/50 transition-colors rounded-r"
              >
                <div className="flex justify-between items-start mb-2">
                  ...
                  {section.level <= 3 && (
                    <button
                      ...
                      className="ml-4 px-3 py-1 text-sm bg-blue-950 text-blue-300 border border-blue-800 rounded hover:bg-blue-900 flex-shrink-0"
                    >
                      재검토 요청
                    </button>
                  )}
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <textarea
              ...
              className="w-full h-32 p-3 border border-gray-600 rounded bg-gray-700 text-gray-100 resize-none mb-4 focus:outline-none focus:border-blue-500"
              autoFocus
            />
